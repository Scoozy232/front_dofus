...
function Welcome() {
    ...
    return (
        <div className='min-h-full relative h-full pb-10 text-white'>
            <h1 className={'text-center text-4xl font-bold text-gray-900 pt-10'}>Bienvenue sur Dofus pour les pros
                !</h1>
            <div className="w-full p-6 m-auto my-10  bg-gray-900 rounded-lg lg:max-w-xl">
                <div><p>Cette application web à été créé pour toi, joueur Dofus, afin de t'aider à savoir où tu en es
                    rendus sur le jeu.</p>
                    ...
                    <div className='my-5'><p>N'hésite plus si tu es un grand fan Dofus comme nous je sais que tu as déjà
                        ton compte ! </p>
