...
function Welcome() {
    ...
    return (
        <div className='min-h-full relative h-full pb-10'>
            ...
            <div className="w-full p-6 m-auto my-10 border-4 border-gray-900 rounded-lg   lg:max-w-xl">
                ...
                <div className='my-5'><p>N'hésite pus si tu es un grand fan Dofus comme nous je sais que tu as déjà ton compte ! </p>
                <Link to="/signin">
                    <button type="button"
